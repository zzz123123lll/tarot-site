...
export function mount(root, H) {
  H.injectCss(".file-list{margin-top:16px}.file-row{display:flex;align-items:center;gap:8px;font-size:14px;color:#1d1d1f;padding:8px 0;border-bottom:1px solid rgba(0,0,0,.06)}.file-row .n{color:#86868b;font-size:14px;min-width:16px}.file-row .nm{flex:1;min-width:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.file-row .mv{background:none;border:none;color:#86868b;cursor:pointer;font-size:14px;padding:2px 6px;border-radius:4px}.file-row .mv:hover{color:#1d1d1f;background:#f5f5f7}.file-row .rm{background:none;border:none;color:#86868b;cursor:pointer;font-size:15px}.file-row .rm:hover{color:#d70015}.gen-bar{display:none;margin-top:18px}.note{font-size:14px;margin-top:12px;display:none}.note.ok{color:#1d9e4e}.note.err{color:#d70015}.opt-row{display:flex;align-items:center;gap:14px;margin-bottom:20px;flex-wrap:wrap}.opt-row label{font-size:14px;color:#6e6e73;white-space:nowrap}.seg{display:inline-flex;background:#f5f5f7;border-radius:10px;padding:3px}.seg button{flex:1;padding:7px 14px;border:none;border-radius:8px;background:transparent;color:#6e6e73;font-size:14px;font-weight:500;font-family:inherit;cursor:pointer}.seg button.active{background:#fff;color:#1d1d1f;box-shadow:0 1px 3px rgba(0,0,0,.12)}.tool-drop .icon svg{width:40px;height:40px;color:#0071e3}");
  root.innerHTML =
